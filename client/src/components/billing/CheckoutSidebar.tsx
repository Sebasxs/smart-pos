...
export const CheckoutSidebar = ({
   ...
   return (
      <aside className="w-full lg:w-[340px] lg:shrink-0 flex flex-col h-fit lg:max-h-full pr-1 overflow-hidden relative">
         <div className="flex flex-col h-fit max-h-full bg-zinc-900/50 rounded-xl border border-zinc-800 shadow-sm overflow-y-auto lg:custom-scrollbar">
            {/* CLIENT SECTION */}
            <div className="flex flex-col h-auto shrink-0">
               <div className="py-3 px-4 border-b border-zinc-800 bg-zinc-800/50 flex justify-between items-center shrink-0">
               ...
               <div className="p-4 h-auto border-b border-zinc-800/10">
                  {!checkoutData.customer.id ? (
                     <button
            ...
            {/* TOTALS & LEGEND */}
            <div className="shrink-0 bg-zinc-900/40 border-t border-zinc-800">
               <CheckoutTotals
                  subtotal={subtotal}
                  discount={discount}
