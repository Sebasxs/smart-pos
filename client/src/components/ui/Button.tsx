...
type ButtonVariant = 'primary' | 'secondary' | 'outline' | 'ghost' | 'danger' | 'disabled';
...
const variants: Record<ButtonVariant, string> = {
   primary:
      'bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 text-white shadow-lg shadow-blue-500/20 border border-transparent',
   secondary:
   ...
   disabled: 'bg-zinc-800 border border-zinc-700 text-zinc-600 cursor-not-allowed',
};
...
export const Button = ({
   ...
   return (
      <button
         ...
         {...props}
      >
         {isLoading && <HiOutlineArrowPath className="animate-spin" size={16} />}
         {children}
      </button>
   );
};
